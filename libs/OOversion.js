...
var color=[[252,229,286],[243,255,58],[35,252,0],[150, 255, 215],[37, 238, 255],[114, 111, 253],[250, 111, 253],[253, 75, 75]]
...
dot.prototype.draw = function() {
	ctx.fillStyle="rgba("+color[this.color][0]+","+color[this.color][1]+","+color[this.color][2]+","+this.alpha+")";
	ctx.beginPath();
